    ...
    private static Task HandleExceptionAsync(HttpContext context, Exception exception)
        {
            ...
            exceptionMessage = "\"error\": \"" + result.Error + "\",";
            exceptionMessage += "\"internalcode\": \"" + result.Internalcode + "\"";
            ...
            //Log the JSON error to the database or error logging
